...
function Create() {
  ...
  // The strategy buttons must have something to build from: live input, the
  // accumulated chat, or a prompt already locked in. With all of them empty,
  // the buttons stay disabled instead of building from a stale default.
  const hasBuildPrompt = Boolean(
    chatInput.trim() || chatPrompt.trim() || (studio.prompt ?? "").trim(),
  );
          ...
          <div className="p-3 sm:p-4">
            ...
            <div className="mx-auto mt-3 grid w-full max-w-3xl gap-2.5 sm:grid-cols-2">
              <button
                ...
                disabled={phase === "building" || !hasBuildPrompt}
                title={!hasBuildPrompt ? "Describe your game first" : undefined}
                className="group flex items-center gap-3 rounded-2xl border border-indigo-400/20 bg-gradient-to-br from-[#2b2670] to-[#171238] p-3.5 text-left transition hover:border-indigo-300/40 disabled:cursor-not-allowed disabled:opacity-60"
              >
              ...
              <button
                ...
                disabled={phase === "building" || !hasBuildPrompt}
                title={!hasBuildPrompt ? "Describe your game first" : undefined}
                className="group flex items-center gap-3 rounded-2xl border border-pink-400/25 bg-gradient-to-br from-[#86158f] to-[#3b0444] p-3.5 text-left transition hover:border-pink-300/50 disabled:cursor-not-allowed disabled:opacity-60"
              >
                <span className="grid size-10 shrink-0 place-items-center rounded-xl bg-white/10">
